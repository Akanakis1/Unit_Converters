...
# Input from user
from_unit = validate_unit("Select the unit of length you want to convert FROM (1-11): ")
num_from = validate_length("Enter the length to be converted: ")
to_unit = validate_unit("Select the unit of length you want to convert TO (1-11): ")
